    ...
    <div className="min-h-screen bg-navy">
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Portal preview — vizualno predstavi šta kupac dobiva */}
          <div className="bg-gradient-to-br from-navy-50 to-gold/5 border border-gold/20 rounded-2xl p-6 sm:p-8 mt-8">
            <div className="text-center mb-6">
              <Badge className="mb-3 bg-gold/15 text-gold border-gold/30">Pogled iz unutra</Badge>
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">Ovako izgleda tvoj portal</h3>
              <p className="text-white/60 max-w-2xl mx-auto">
                Čistih 90 dana — bez reklama, bez distrakcija. Samo ti, video, tvoje bilješke i tvoj napredak.
                Svaki dan zna gdje si stao i točno što slijedi.
              </p>
            </div>

            {/* Browser-style frame z mockupom portala */}
            <div className="max-w-4xl mx-auto rounded-xl overflow-hidden border border-white/15 shadow-2xl">
              {/* Top bar */}
              <div className="bg-navy/80 px-4 py-2 flex items-center gap-2 border-b border-white/10">
                <div className="flex gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-red-500/60" />
                  <div className="w-2.5 h-2.5 rounded-full bg-yellow-500/60" />
                  <div className="w-2.5 h-2.5 rounded-full bg-green-500/60" />
                </div>
                <div className="flex-1 text-center text-xs text-white/40 font-mono">fincoach.vip/portal/dan/2</div>
              </div>
              {/* Body s 2 stolpca */}
              <div className="flex bg-navy">
                {/* Sidebar */}
                <div className="hidden sm:flex flex-col w-44 bg-navy-50/80 border-r border-white/10 px-3 py-4 text-xs">
                  <p className="text-gold font-bold mb-3 px-1">FinCoach VIP</p>
                  <div className="space-y-1 text-white/70">
                    <div className="px-2 py-1 rounded bg-gold/10 text-gold">📊 Pregled</div>
                    <div className="px-2 py-1 text-white/50">📝 Moje bilješke</div>
                    <div className="px-2 py-1 text-white/50">🏆 Certifikat</div>
                    <div className="px-2 py-1 text-white/50">🔗 Affiliate</div>
                  </div>
                  <p className="text-white/30 text-[10px] uppercase tracking-widest mt-4 mb-1.5 px-1">Tjedan 1–4</p>
                  <div className="space-y-0.5 text-[11px]">
                    <div className="px-2 py-0.5 text-green-400">✓ Dan 1 — Put prema slobodi</div>
                    <div className="px-2 py-0.5 text-gold bg-gold/5 rounded">▶ Dan 2 — Financijske strategije</div>
                    <div className="px-2 py-0.5 text-white/40">○ Dan 3 — Volim svoj novac</div>
                    <div className="px-2 py-0.5 text-white/40">○ Dan 4 — Afirmacije</div>
                    <div className="px-2 py-0.5 text-white/30">...</div>
                  </div>
                  <div className="mt-3 pt-3 border-t border-white/10">
                    <div className="flex justify-between text-[10px] text-white/40 mb-1">
                      <span>Napredak</span><span className="text-gold font-semibold">1/90</span>
                    </div>
                    <div className="h-1 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-gold rounded-full" style={{ width: '1.1%' }} />
                    </div>
                  </div>
                </div>
                {/* Content */}
                <div className="flex-1 p-4 sm:p-6">
                  <div className="text-[10px] text-white/40 mb-2">Dashboard › Faza 1 › Dan 2</div>
                  <h4 className="text-white font-bold text-base sm:text-lg mb-3">Financijske strategije za osvajanje ciljeva</h4>
                  {/* Video frame */}
                  <div className="aspect-video bg-black/80 rounded-lg border border-white/10 flex items-center justify-center mb-3 relative">
                    <div className="w-12 h-12 rounded-full bg-gold flex items-center justify-center">
                      <svg className="w-5 h-5 text-navy ml-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M6.3 2.841A1.5 1.5 0 004 4.11v11.78a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" />
                      </svg>
                    </div>
                    <div className="absolute bottom-2 left-2 right-2 h-1 bg-white/10 rounded">
                      <div className="h-full bg-gold rounded" style={{ width: '38%' }} />
                    </div>
                  </div>
                  <div className="bg-navy-50/60 border border-white/10 rounded-lg p-3 mb-3">
                    <p className="text-white/80 text-xs font-semibold mb-1">O ovoj lekciji</p>
                    <p className="text-white/50 text-[11px] leading-relaxed">
                      "Upravljanje financijama je vještina koju svatko može savladati."
                      Danas razmišljamo o vašim financijskim uvjerenjima — onima koja ste stekli od važnih osoba u vašem životu...
                    </p>
                  </div>
                  <div className="bg-navy-50/60 border border-white/10 rounded-lg p-3">
                    <p className="text-white/80 text-xs font-semibold mb-1">📝 Moje bilješke</p>
                    <p className="text-white/30 text-[11px] italic">Napiši svoje misli, zadatke ili uvide za ovaj dan...</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Motivacijski tekst pod mockupom */}
            <div className="max-w-3xl mx-auto text-center mt-8">
              <p className="text-lg sm:text-xl text-white font-semibold mb-3">
                Za 90 dana ne mijenjaš samo svoje financije — mijenjaš odnos prema novcu, sebi i budućnosti koju gradiš.
              </p>
              <p className="text-white/60 leading-relaxed">
                Otvori portal. Klikni "Označi kao završeno". Zapiši što si naučio. Sutra te čeka sljedeći korak.
                Bez stresa, bez rokova — tvojim tempom, ali svaki dan bliže slobodi.
              </p>
            </div>
          </div>
